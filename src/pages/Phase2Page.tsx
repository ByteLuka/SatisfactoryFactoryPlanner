  ...
  return (
    <div className="min-h-screen bg-[#1a1a1f] text-[#e8e8f0] flex flex-col">
      ...
      <div className="flex flex-1 min-h-0">
        {/* Left panel */}
        <aside className="w-80 flex-shrink-0 border-r border-[#3a3a46] overflow-y-auto p-4">
          <TargetInputPanel
            planState={planState}
            dispatch={dispatch}
          ...
          {/* Plan summary */}
          {activePlan && (
            <div className="mt-4 bg-[#25252d] border border-[#3a3a46] rounded-lg p-4">
        ...
        {/* Graph area */}
        <main className="flex-1 relative min-h-0" style={{ height: 'calc(100vh - 65px)' }}>
          {/* Error overlay */}
          {errorMessage && (
